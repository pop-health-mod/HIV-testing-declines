...
#include <iomanip>  // for std::setprecision, std::fixed, etc.
...
extern "C" {
  ...
  SEXP eppasmancC(SEXP s_fp) {
    ...
    int t_anc_start = *INTEGER(getListElement(s_fp, "t_anc_start")) - 1; //(35-1), consider anc testing to start in 2005 
    ...
    multi_array_ref<double, 4> anc_rate(REAL(getListElement(s_fp, "anc_rate")), extents[PROJ_YEARS][pDS][NG][hAG]);
    multi_array_ref<double, 5> anc_diagn_rate(REAL(getListElement(s_fp, "anc_diagn_rate")), extents[PROJ_YEARS][5][NG][hAG][hDS]);
    ...
    SEXP s_testnegpop = PROTECT(Rf_allocVector(REALSXP, hAG * NG * pDS * anc * PROJ_YEARS));
    SEXP s_testnegpop_dim = PROTECT(Rf_allocVector(INTSXP, 5));
    INTEGER(s_testnegpop_dim)[0] = hAG;
    INTEGER(s_testnegpop_dim)[1] = NG;
    INTEGER(s_testnegpop_dim)[2] = pDS;
    INTEGER(s_testnegpop_dim)[3] = anc;
    INTEGER(s_testnegpop_dim)[4] = PROJ_YEARS;
    Rf_setAttrib(s_testnegpop, R_DimSymbol, s_testnegpop_dim);
    Rf_setAttrib(s_pop, Rf_install("testnegpop"), s_testnegpop);
    multi_array_ref<double, 5> testnegpop(REAL(s_testnegpop), extents[PROJ_YEARS][anc][pDS][NG][hAG]);
    memset(REAL(s_testnegpop), 0, Rf_length(s_testnegpop) * sizeof(double));
    
    /*SEXP s_testnegpop_anc = PROTECT(Rf_allocVector(REALSXP, hAG * NG * pDS * anc * PROJ_YEARS));
    SEXP s_testnegpop_anc_dim = PROTECT(Rf_allocVector(INTSXP, 4));
    INTEGER(s_testnegpop_anc_dim)[0] = hAG;
    INTEGER(s_testnegpop_anc_dim)[1] = NG;
    INTEGER(s_testnegpop_anc_dim)[2] = pDS;
    INTEGER(s_testnegpop_anc_dim)[3] = PROJ_YEARS;
    Rf_setAttrib(s_testnegpop_anc, R_DimSymbol, s_testnegpop_anc_dim);
    Rf_setAttrib(s_pop, Rf_install("testnegpop_anc"), s_testnegpop_anc);
    multi_array_ref<double, 4> testnegpop_anc(REAL(s_testnegpop_anc), extents[PROJ_YEARS][pDS][NG][hAG]);
    memset(REAL(s_testnegpop_anc), 0, Rf_length(s_testnegpop_anc) * sizeof(double));
    */

    SEXP s_diagnpop = PROTECT(Rf_allocVector(REALSXP, hDS * hAG * NG * anc * PROJ_YEARS));
    SEXP s_diagnpop_dim = PROTECT(Rf_allocVector(INTSXP, 5));
    INTEGER(s_diagnpop_dim)[0] = hDS;
    INTEGER(s_diagnpop_dim)[1] = hAG;
    INTEGER(s_diagnpop_dim)[2] = NG;
    INTEGER(s_diagnpop_dim)[3] = anc;
    INTEGER(s_diagnpop_dim)[4] = PROJ_YEARS;
    Rf_setAttrib(s_diagnpop, R_DimSymbol, s_diagnpop_dim);
    Rf_setAttrib(s_pop, Rf_install("diagnpop"), s_diagnpop);
    multi_array_ref<double, 5> diagnpop(REAL(s_diagnpop), extents[PROJ_YEARS][anc][NG][hAG][hDS]);
    memset(REAL(s_diagnpop), 0, Rf_length(s_diagnpop)*sizeof(double));
    
    
    /*SEXP s_diagnpop_anc = PROTECT(Rf_allocVector(REALSXP, hDS * hAG * NG * PROJ_YEARS));
    SEXP s_diagnpop_anc_dim = PROTECT(Rf_allocVector(INTSXP, 4));
    INTEGER(s_diagnpop_anc_dim)[0] = hDS;
    INTEGER(s_diagnpop_anc_dim)[1] = hAG;
    INTEGER(s_diagnpop_anc_dim)[2] = NG;
    INTEGER(s_diagnpop_anc_dim)[3] = PROJ_YEARS;
    Rf_setAttrib(s_diagnpop_anc, R_DimSymbol, s_diagnpop_anc_dim);
    Rf_setAttrib(s_pop, Rf_install("diagnpop_anc"), s_diagnpop_anc);
    multi_array_ref<double, 4> diagnpop_anc(REAL(s_diagnpop_anc), extents[PROJ_YEARS][NG][hAG][hDS]);
    memset(REAL(s_diagnpop_anc), 0, Rf_length(s_diagnpop_anc) * sizeof(double));
    */
    SEXP s_artpop = PROTECT(Rf_allocVector(REALSXP, hTS * hDS * hAG * NG * anc * PROJ_YEARS));
    SEXP s_artpop_dim = PROTECT(Rf_allocVector(INTSXP, 6));
    INTEGER(s_artpop_dim)[0] = hTS;
    INTEGER(s_artpop_dim)[1] = hDS;
    INTEGER(s_artpop_dim)[2] = hAG;
    INTEGER(s_artpop_dim)[3] = NG;
    INTEGER(s_artpop_dim)[4] = anc;
    INTEGER(s_artpop_dim)[5] = PROJ_YEARS;
    Rf_setAttrib(s_artpop, R_DimSymbol, s_artpop_dim);
    Rf_setAttrib(s_pop, Rf_install("artpop"), s_artpop);
    multi_array_ref<double, 6> artpop(REAL(s_artpop), extents[PROJ_YEARS][anc][NG][hAG][hDS][hTS]);
    ...
    // 4: positive, diagnosed and untreated
    // 5: positive, on ART
    SEXP s_anctests = PROTECT(Rf_allocVector(REALSXP, hAG * NG * 6 * PROJ_YEARS));
    SEXP s_anctests_dim = PROTECT(Rf_allocVector(INTSXP, 4));
    INTEGER(s_anctests_dim)[0] = hAG;
    INTEGER(s_anctests_dim)[1] = NG;
    INTEGER(s_anctests_dim)[2] = 6;
    INTEGER(s_anctests_dim)[3] = PROJ_YEARS;
    Rf_setAttrib(s_anctests, R_DimSymbol, s_anctests_dim);
    Rf_setAttrib(s_pop, Rf_install("anctests"), s_anctests);
    multi_array_ref<double, 4> anctests(REAL(s_anctests), extents[PROJ_YEARS][6][NG][hAG]);
    memset(REAL(s_anctests), 0, Rf_length(s_anctests) * sizeof(double));
    ...
    // 4: positive, diagnosed and untreated
    // 5: positive, on ART
    SEXP s_vcttests = PROTECT(Rf_allocVector(REALSXP, hAG * NG * 6 * PROJ_YEARS));
    SEXP s_vcttests_dim = PROTECT(Rf_allocVector(INTSXP, 4));
    INTEGER(s_vcttests_dim)[0] = hAG;
    INTEGER(s_vcttests_dim)[1] = NG;
    INTEGER(s_vcttests_dim)[2] = 6;
    INTEGER(s_vcttests_dim)[3] = PROJ_YEARS;
    Rf_setAttrib(s_vcttests, R_DimSymbol, s_vcttests_dim);
    Rf_setAttrib(s_pop, Rf_install("vcttests"), s_vcttests);
    multi_array_ref<double, 4> vcttests(REAL(s_vcttests), extents[PROJ_YEARS][6][NG][hAG]);
    memset(REAL(s_vcttests), 0, Rf_length(s_vcttests) * sizeof(double));

    
    SEXP s_diagnoses = PROTECT(Rf_allocVector(REALSXP, hDS * hAG * NG * anc * PROJ_YEARS));
    SEXP s_diagnoses_dim = PROTECT(Rf_allocVector(INTSXP, 5));
    INTEGER(s_diagnoses_dim)[0] = hDS;
    INTEGER(s_diagnoses_dim)[1] = hAG;
    INTEGER(s_diagnoses_dim)[2] = NG;
    INTEGER(s_diagnoses_dim)[3] = anc;
    INTEGER(s_diagnoses_dim)[4] = PROJ_YEARS;
    Rf_setAttrib(s_diagnoses, R_DimSymbol, s_diagnoses_dim);
    Rf_setAttrib(s_pop, Rf_install("diagnoses"), s_diagnoses);
    multi_array_ref<double, 5> diagnoses(REAL(s_diagnoses), extents[PROJ_YEARS][anc][NG][hAG][hDS]);
    memset(REAL(s_diagnoses), 0, Rf_length(s_diagnoses) * sizeof(double));
    
    SEXP s_diagnoses_anc = PROTECT(Rf_allocVector(REALSXP, hDS * hAG * NG * PROJ_YEARS));
    SEXP s_diagnoses_anc_dim = PROTECT(Rf_allocVector(INTSXP, 4));
    INTEGER(s_diagnoses_anc_dim)[0] = hDS;
    INTEGER(s_diagnoses_anc_dim)[1] = hAG;
    INTEGER(s_diagnoses_anc_dim)[2] = NG;
    INTEGER(s_diagnoses_anc_dim)[3] = PROJ_YEARS;
    Rf_setAttrib(s_diagnoses_anc, R_DimSymbol, s_diagnoses_anc_dim);
    Rf_setAttrib(s_pop, Rf_install("diagnoses_anc"), s_diagnoses_anc);
    multi_array_ref<double, 4> diagnoses_anc(REAL(s_diagnoses_anc), extents[PROJ_YEARS][NG][hAG][hDS]);
    memset(REAL(s_diagnoses_anc), 0, Rf_length(s_diagnoses_anc) * sizeof(double));
    
    SEXP s_diagnoses_non_anc = PROTECT(Rf_allocVector(REALSXP, hDS * hAG * NG * PROJ_YEARS));
    SEXP s_diagnoses_non_anc_dim = PROTECT(Rf_allocVector(INTSXP, 4));
    INTEGER(s_diagnoses_non_anc_dim)[0] = hDS;
    INTEGER(s_diagnoses_non_anc_dim)[1] = hAG;
    INTEGER(s_diagnoses_non_anc_dim)[2] = NG;
    INTEGER(s_diagnoses_non_anc_dim)[3] = PROJ_YEARS;
    Rf_setAttrib(s_diagnoses_non_anc, R_DimSymbol, s_diagnoses_non_anc_dim);
    Rf_setAttrib(s_pop, Rf_install("diagnoses_non_anc"), s_diagnoses_non_anc);
    multi_array_ref<double, 4> diagnoses_non_anc(REAL(s_diagnoses_non_anc), extents[PROJ_YEARS][NG][hAG][hDS]);
    memset(REAL(s_diagnoses_non_anc), 0, Rf_length(s_diagnoses_non_anc) * sizeof(double));
    
    
    SEXP s_late_diagnoses = PROTECT(Rf_allocVector(REALSXP, hDS * hAG * NG * anc * PROJ_YEARS));
    SEXP s_late_diagnoses_dim = PROTECT(Rf_allocVector(INTSXP, 5));
    INTEGER(s_late_diagnoses_dim)[0] = hDS;
    INTEGER(s_late_diagnoses_dim)[1] = hAG;
    INTEGER(s_late_diagnoses_dim)[2] = NG;
    INTEGER(s_late_diagnoses_dim)[3] = anc;
    INTEGER(s_late_diagnoses_dim)[4] = PROJ_YEARS;
    ...
    multi_array_ref<double, 5> late_diagnoses(REAL(s_late_diagnoses), extents[PROJ_YEARS][anc][NG][hAG][hDS]);
    memset(REAL(s_late_diagnoses), 0, Rf_length(s_late_diagnoses) * sizeof(double));
    
    SEXP s_artinits = PROTECT(Rf_allocVector(REALSXP, hDS * hAG * NG * anc * PROJ_YEARS));
    SEXP s_artinits_dim = PROTECT(Rf_allocVector(INTSXP, 5));
    INTEGER(s_artinits_dim)[0] = hDS;
    INTEGER(s_artinits_dim)[1] = hAG;
    INTEGER(s_artinits_dim)[2] = NG;
    INTEGER(s_artinits_dim)[3] = anc;
    INTEGER(s_artinits_dim)[4] = PROJ_YEARS;
    Rf_setAttrib(s_artinits, R_DimSymbol, s_artinits_dim);
    Rf_setAttrib(s_pop, Rf_install("artinits"), s_artinits);
    multi_array_ref<double, 5> artinits(REAL(s_artinits), extents[PROJ_YEARS][anc][NG][hAG][hDS]);
      ...
      for(int t = 1; t < SIM_YEARS; t++){
        ...
        if (t > t_hts_start) {
          ...
          for (int an = 0; an < anc; an++) {
              for (int g = 0; g < NG; g++) {
                  for (int ha = 1; ha < hAG; ha++) {
                      testnegpop[t][an][HIVN][g][ha] = (1 - hivn_ag_prob[g][ha]) * testnegpop[t - 1][an][HIVN][g][ha] + hivn_ag_prob[g][ha - 1] * testnegpop[t - 1][an][HIVN][g][ha - 1];
                      testnegpop[t][an][HIVP][g][ha] = (1 - hiv_ag_prob[g][ha]) * testnegpop[t - 1][an][HIVP][g][ha] + hiv_ag_prob[g][ha - 1] * testnegpop[t - 1][an][HIVP][g][ha - 1];
                  }
              }
          }
        }
        ...
        for (int g = 0; g < NG; g++) {
            for (int ha = 1; ha < hAG; ha++) {
                for (int hm = 0; hm < hDS; hm++) {
                    ...
                    if (t > t_hts_start) {
                        diagnpop[t][0][g][ha][hm] = (1 - hiv_ag_prob[g][ha]) * diagnpop[t - 1][0][g][ha][hm] + hiv_ag_prob[g][ha - 1] * diagnpop[t - 1][0][g][ha - 1][hm];
                        diagnpop[t][1][g][ha][hm] = (1 - hiv_ag_prob[g][ha]) * diagnpop[t - 1][1][g][ha][hm] + hiv_ag_prob[g][ha - 1] * diagnpop[t - 1][1][g][ha - 1][hm];
                    }

                    if (t > t_ART_start) {
                        for (int hu = 0; hu < hTS; hu++) {
                            
                            artpop[t][0][g][ha][hm][hu] = (1 - hiv_ag_prob[g][ha]) * artpop[t - 1][0][g][ha][hm][hu] + hiv_ag_prob[g][ha - 1] * artpop[t - 1][0][g][ha - 1][hm][hu];
                            
                            artpop[t][1][g][ha][hm][hu] = (1 - hiv_ag_prob[g][ha]) * artpop[t - 1][1][g][ha][hm][hu] + hiv_ag_prob[g][ha - 1] * artpop[t - 1][1][g][ha - 1][hm][hu];
                        }
                    }
        ...
        for (int g = 0; g < NG; g++) {
            ...
            if (t > t_hts_start) {
                testnegpop[t][0][HIVN][g][0] = (1 - hivn_ag_prob[g][0]) * testnegpop[t - 1][0][HIVN][g][0];
                testnegpop[t][1][HIVN][g][0] = (1 - hivn_ag_prob[g][0]) * testnegpop[t - 1][1][HIVN][g][0];
                testnegpop[t][0][HIVP][g][0] = (1 - hiv_ag_prob[g][0]) * testnegpop[t - 1][0][HIVP][g][0];
                testnegpop[t][1][HIVP][g][0] = (1 - hiv_ag_prob[g][0]) * testnegpop[t - 1][1][HIVP][g][0];
            }

            for (int hm = 0; hm < hDS; hm++) {
                hivpop[t][g][0][hm] = (1 - hiv_ag_prob[g][0]) * hivpop[t - 1][g][0][hm] + paedsurv_g * paedsurv_cd4dist[t][g][hm] * (1.0 - entrantartcov[t][g]);
                if (t > t_hts_start) {
                    diagnpop[t][0][g][0][hm] = (1 - hiv_ag_prob[g][0]) * diagnpop[t - 1][0][g][0][hm];
                    diagnpop[t][1][g][0][hm] = (1 - hiv_ag_prob[g][0]) * diagnpop[t - 1][1][g][0][hm];
                }
                
                if (t > t_ART_start) {
                    for (int hu = 0; hu < hTS; hu++) {
                        
                        // assume all entrants were tested at vct(unlikely to be anc tested before 15years of age)
                        // non-ANC (anc = 0)
                        artpop[t][0][g][0][hm][hu] =
                            (1 - hiv_ag_prob[g][0]) * artpop[t - 1][0][g][0][hm][hu] +
                            paedsurv_g * paedsurv_artcd4dist[t][g][hm][hu] * entrantartcov[t][g];

                        // ANC (anc = 1)
                        artpop[t][1][g][0][hm][hu] =
                            (1 - hiv_ag_prob[g][0]) * artpop[t - 1][1][g][0][hm][hu];
        ...
        for (int g = 0; g < NG; g++) {
          ...
          for (int ha = 0; ha < hAG; ha++) {
            ...
            if (t > t_hts_start) {
                ...
                for (int an = 0; an < anc; an++) {
                    testnegpop[t][an][HIVN][g][ha] *= 1 + deathmigrate_hivn_ha;
                    testnegpop[t][an][HIVP][g][ha] *= 1 + deathmigrate_ha;
                } // loop over an
            }
            for (int hm = 0; hm < hDS; hm++) {
                ...
                for (int an = 0; an < anc; an++) {
                    if (t > t_hts_start)
                        diagnpop[t][an][g][ha][hm] *= 1 + deathmigrate_ha;
                    if (t > t_ART_start)
                        for (int hu = 0; hu < hTS; hu++)
                            artpop[t][an][g][ha][hm][hu] *= 1 + deathmigrate_ha;
                } // loop over an (outside hivpop to not double count deaths)
            } // loop over hm 
          } // loop over ha
            ...
            for (int ha = 0; ha < hAG; ha++) {
              for (int hm = 0; hm < hDS; hm++) {
                ...
                if (scale_cd4_mort && t >= t_ART_start && hm >= everARTelig_idx) {
                  ...
                  for (int hu = 0; hu < hTS; hu++) {
                      for (int an = 0; an < anc; an++) {
                          artpop_hahm += artpop[t][an][g][ha][hm][hu];
                      }
          ...
          if (t >= t_hts_start) {
            for (int g = 0; g < NG; g++) {
                ...
                for (int ha = 0; ha < hAG; ha++) {
                    ...
                    // number of new infections among never tested (proportional to the HIV-neg pop)(at start)
                    double testneg_infections_ha = infections_ha * (testnegpop[t][0][HIVN][g][ha] / hivn_pop_ha);
                    double testneg_infections_ha_anc = infections_ha * (testnegpop[t][1][HIVN][g][ha] / hivn_pop_ha);
                    // allows for calculations without mid loop adjustment 
                    double midloop_testneg = testnegpop[t][0][HIVN][g][ha];
                    double midloop_testneg_anc = testnegpop[t][1][HIVN][g][ha];
                    double total_test_neg = midloop_testneg+ midloop_testneg_anc;
                    
                    double midloop_pos_testneg = testnegpop[t][0][HIVP][g][ha];
                    double midloop_pos_testneg_anc = testnegpop[t][1][HIVP][g][ha];
                    double total_pos_testneg = midloop_pos_testneg + midloop_pos_testneg_anc;


                    // Tests among HIV negative population
                    vcttests[t][0][g][ha] += DT * hts_rate[t][0][g][ha] * (hivn_pop_ha - (total_test_neg));
                    
                    anctests[t][0][g][ha] += DT * anc_rate[t][0][g][ha] * (hivn_pop_ha - (total_test_neg));
                    
                    vcttests[t][1][g][ha] += DT * hts_rate[t][1][g][ha] * midloop_testneg;
                    vcttests[t][1][g][ha] += DT * hts_rate[t][1][g][ha] * midloop_testneg_anc;

                    //different rates apply to anc retests(anc among vct tested is equal to untested)
                    anctests[t][1][g][ha] += DT * anc_rate[t][0][g][ha] * midloop_testneg;
                    anctests[t][1][g][ha] += DT * anc_rate[t][1][g][ha] * midloop_testneg_anc;

                    
                    //if not 0 check why

                    //non anc
                    testnegpop[t][0][HIVN][g][ha] += DT * hts_rate[t][0][g][ha] * (hivn_pop_ha - (total_test_neg));
                    
                    testnegpop[t][1][HIVN][g][ha] += DT * anc_rate[t][0][g][ha] * (hivn_pop_ha - (total_test_neg));

                    
                    //Remove infections from HIV- testnegpop
                    testnegpop[t][0][HIVN][g][ha] -= DT * testneg_infections_ha;
                    testnegpop[t][1][HIVN][g][ha] -= DT * testneg_infections_ha_anc;
                    
                    
                    //if g == 0 then there is an error
                    // New diagnoses among HIV positive population

                    double grad_diagn[hDS] = {};
                    double grad_diagn_anc[hDS] = {};
                    double grad_testneg_hivp = 0.0;
                    double grad_testneg_hivp_anc = 0.0;

                    // Add infections among testnegpop
                    grad_testneg_hivp += testneg_infections_ha;
                    grad_testneg_hivp_anc += testneg_infections_ha_anc;
                    
                    double grad_testneg_hivp_init = grad_testneg_hivp;
                    
                    double hivpop_ha = 0.0, undiagnosed_ha = 0.0;
                    for (int hm = 0; hm < hDS; hm++) {
                        hivpop_ha += hivpop[t][g][ha][hm];
                        undiagnosed_ha += hivpop[t][g][ha][hm] - (diagnpop[t][0][g][ha][hm] + diagnpop[t][1][g][ha][hm]);
                        
                    }
                    // Remove share of HIV deaths among testneg population
                    grad_testneg_hivp -= hivdeaths_ha[g][ha] / DT * (hivpop_ha > 0 ? midloop_pos_testneg / hivpop_ha : 0.0);
                    grad_testneg_hivp_anc -= hivdeaths_ha[g][ha] / DT * (hivpop_ha > 0 ? midloop_pos_testneg_anc / hivpop_ha : 0.0);
                    double grad_testneg_hivp_mid = grad_testneg_hivp;


                    

                    //use testnegpop for both as it is pulling from a different pool here compared to deaths where it was deaths amoung testneg anc
                    double prop_testneg = (undiagnosed_ha > 0 && midloop_pos_testneg >= 0 ) ? (midloop_pos_testneg) / undiagnosed_ha : 0.0;
                    double prop_testneg_anc = (undiagnosed_ha > 0 && midloop_pos_testneg_anc >= 0) ? (midloop_pos_testneg_anc) / undiagnosed_ha : 0.0;
                    
                    
                    for (int hm = 0; hm < hDS; hm++) {
                        
                        
                        double diagn_naive = diagn_rate[t][0][g][ha][hm] * (1.0 - (prop_testneg + prop_testneg_anc)) * (hivpop[t][g][ha][hm] - (diagnpop[t][0][g][ha][hm]+ diagnpop[t][1][g][ha][hm]));
                        double diagn_naive_anc = anc_diagn_rate[t][0][g][ha][hm] * (1.0 - (prop_testneg + prop_testneg_anc)) * (hivpop[t][g][ha][hm] - (diagnpop[t][0][g][ha][hm] + diagnpop[t][1][g][ha][hm]));

                        //those retested at vct from anc and vct
                        double diagn_testneg_test = diagn_rate[t][1][g][ha][hm] * prop_testneg * (hivpop[t][g][ha][hm] - (diagnpop[t][0][g][ha][hm] + diagnpop[t][1][g][ha][hm]));
                        double diagn_testneg_anc_test = diagn_rate[t][1][g][ha][hm] * prop_testneg_anc * (hivpop[t][g][ha][hm] - (diagnpop[t][0][g][ha][hm] + diagnpop[t][1][g][ha][hm]));

                        //those retested at anc (only retests by anc have increased rate)
                        double diagn_testneg_anctest = anc_diagn_rate[t][0][g][ha][hm] * prop_testneg * (hivpop[t][g][ha][hm] - (diagnpop[t][0][g][ha][hm] + diagnpop[t][1][g][ha][hm]));
                        double diagn_testneg_anc_anctest = anc_diagn_rate[t][1][g][ha][hm] * prop_testneg_anc * (hivpop[t][g][ha][hm] - (diagnpop[t][0][g][ha][hm] + diagnpop[t][1][g][ha][hm]));
                        
                        
                        vcttests[t][2][g][ha] += DT * diagn_naive;
                        vcttests[t][3][g][ha] += DT * (diagn_testneg_test + diagn_testneg_anc_test);
                        vcttests[t][4][g][ha] += DT * diagn_rate[t][2][g][ha][hm] * diagnpop[t][0][g][ha][hm];
                        vcttests[t][4][g][ha] += DT * diagn_rate[t][2][g][ha][hm] * diagnpop[t][1][g][ha][hm];

                        anctests[t][2][g][ha] += DT * diagn_naive_anc;
                        anctests[t][3][g][ha] += DT * (diagn_testneg_anctest + diagn_testneg_anc_anctest);
                        anctests[t][4][g][ha] += DT * anc_diagn_rate[t][2][g][ha][hm] * diagnpop[t][0][g][ha][hm];
                        anctests[t][4][g][ha] += DT * anc_diagn_rate[t][3][g][ha][hm] * diagnpop[t][1][g][ha][hm];

                        if (t >= t_ART_start) {
                            for (int hu = 0; hu < hTS; hu++) {
                                vcttests[t][5][g][ha] += DT * diagn_rate[t][3][g][ha][hm] * artpop[t][0][g][ha][hm][hu];
                                vcttests[t][5][g][ha] += DT * diagn_rate[t][3][g][ha][hm] * artpop[t][1][g][ha][hm][hu];

                                anctests[t][5][g][ha] += DT * anc_diagn_rate[t][4][g][ha][hm] * artpop[t][0][g][ha][hm][hu];
                                anctests[t][5][g][ha] += DT * anc_diagn_rate[t][4][g][ha][hm] * artpop[t][1][g][ha][hm][hu];
                            }
                        }
                    //subtract those who prior tested negative but now were tested pos again 
                    grad_testneg_hivp -= diagn_testneg_test + diagn_testneg_anctest;  // Both VCT and ANC diagnoses from compartment 0
                    grad_testneg_hivp_anc -= diagn_testneg_anc_test + diagn_testneg_anc_anctest;  // Both VCT and ANC diagnoses from compartment 1
                    
                    
                    diagnoses_non_anc[t][g][ha][hm] += DT * (diagn_naive + diagn_testneg_test + diagn_testneg_anc_test);
                    diagnoses_anc[t][g][ha][hm] += DT * (diagn_naive_anc + diagn_testneg_anc_anctest + diagn_testneg_anctest);
                    diagnoses[t][0][g][ha][hm] += DT * ((diagn_naive + diagn_testneg_test + diagn_testneg_anc_test));
                    diagnoses[t][1][g][ha][hm] += DT * ((diagn_naive_anc + diagn_testneg_anc_anctest + diagn_testneg_anctest));

                    
                    grad_diagn[hm] = (diagn_naive + diagn_testneg_test) - (cd4_mort[g][ha][hm] * diagnpop[t][0][g][ha][hm]);
                    grad_diagn_anc[hm] = (diagn_naive_anc + diagn_testneg_anc_anctest + diagn_testneg_anctest + diagn_testneg_anc_test) - (cd4_mort[g][ha][hm] * diagnpop[t][1][g][ha][hm]);
                    ...
                    for (int hm = 1; hm < hDS; hm++) {
                        ...
                        grad_diagn[hm - 1] -= cd4_prog[g][ha][hm - 1] * diagnpop[t][0][g][ha][hm - 1];
                        grad_diagn[hm] += cd4_prog[g][ha][hm - 1] * diagnpop[t][0][g][ha][hm - 1];
                    
                        grad_diagn_anc[hm - 1] -= cd4_prog[g][ha][hm - 1] * diagnpop[t][1][g][ha][hm - 1];
                        grad_diagn_anc[hm] += cd4_prog[g][ha][hm - 1] * diagnpop[t][1][g][ha][hm - 1];

                    }


                    testnegpop[t][0][HIVP][g][ha] += DT * (grad_testneg_hivp);
                    testnegpop[t][1][HIVP][g][ha] += DT * (grad_testneg_hivp_anc);
                    
                    
                    
                    for (int hm = 0; hm < hDS; hm++) {
                        
                        diagnpop[t][0][g][ha][hm] += DT * grad_diagn[hm];
                        diagnpop[t][1][g][ha][hm] += DT * grad_diagn_anc[hm];
              ...
              for (int g = 0; g < NG; g++) {
                  for (int ha = 0; ha < hAG; ha++) {
                      for (int hm = everARTelig_idx; hm < hDS; hm++) {
                          ...
                          double gradART[hTS] = {};
                          double gradART_anc[hTS] = {};

                          for (int hu = 0; hu < hTS; hu++) {
                              double deaths = art_mort[g][ha][hm][hu] * artmx_timerr[t][hu] * artpop[t][0][g][ha][hm][hu];
                              double deaths_anc = art_mort[g][ha][hm][hu] * artmx_timerr[t][hu] * artpop[t][1][g][ha][hm][hu];

                              hivdeaths_ha[g][ha] += DT * (deaths + deaths_anc);
                              artpopdeaths[t][g][ha][hm][hu] += DT * (deaths + deaths_anc);
                              gradART[hu] = -deaths;
                              gradART_anc[hu] = -deaths_anc;

                          }
                            
                          gradART[ART0MOS] += -ART_STAGE_PROG_RATE * artpop[t][0][g][ha][hm][ART0MOS];
                          gradART[ART6MOS] += ART_STAGE_PROG_RATE * artpop[t][0][g][ha][hm][ART0MOS] - ART_STAGE_PROG_RATE * artpop[t][0][g][ha][hm][ART6MOS];
                          gradART[ART1YR] += ART_STAGE_PROG_RATE * artpop[t][0][g][ha][hm][ART6MOS];

                          gradART_anc[ART0MOS] += -ART_STAGE_PROG_RATE * artpop[t][1][g][ha][hm][ART0MOS];
                          gradART_anc[ART6MOS] += ART_STAGE_PROG_RATE * artpop[t][1][g][ha][hm][ART0MOS] - ART_STAGE_PROG_RATE * artpop[t][1][g][ha][hm][ART6MOS];
                          gradART_anc[ART1YR] += ART_STAGE_PROG_RATE * artpop[t][1][g][ha][hm][ART6MOS];
                          
                          
                          for (int hu = 0; hu < hTS; hu++) {
                              artpop[t][0][g][ha][hm][hu] += DT * gradART[hu];
                              artpop[t][1][g][ha][hm][hu] += DT * gradART_anc[hu];
                          }
                    ...
                    for (int ha = 0; ha < hAG; ha++) {
                        for (int hm = everARTelig_idx; hm < hDS; hm++) {
                            for (int hu = 0; hu < hTS; hu++) {
                                ...
                                double dropout_ts = DT * art_dropout[t] * artpop[t][0][g][ha][hm][hu];
                                double dropout_ts_anc = DT * art_dropout[t] * artpop[t][1][g][ha][hm][hu];
                                
                                if (bin_art_dropout_recover_cd4 && hu >= 2 && hm >= 1) {
                                    // recover people on ART >1 year to one higher CD4 category
                                    hivpop[t][g][ha][hm - 1] += dropout_ts + dropout_ts_anc;
                                    if (t >= t_hts_start) {
                                        
                                        diagnpop[t][0][g][ha][hm - 1] += dropout_ts;
                                        diagnpop[t][1][g][ha][hm - 1] += dropout_ts_anc;   
                                        
                                    }
                                } else {
                                    hivpop[t][g][ha][hm] += dropout_ts + dropout_ts_anc;
                                    if (t >= t_hts_start) {
                                        
                                        diagnpop[t][0][g][ha][hm] += dropout_ts;
                                        diagnpop[t][1][g][ha][hm] += dropout_ts_anc;
                                                                                
                                    }
                                }
                                
                                artpop[t][0][g][ha][hm][hu] -= dropout_ts;
                                artpop[t][1][g][ha][hm][hu] -= dropout_ts_anc;
            ...
            for (int g = 0; g < NG; g++) {
              ...
              for (int ha = hIDX_15PLUS; ha < hAG; ha++) {
                  ...
                  for (int hm = everARTelig_idx; hm < hDS; hm++) {
                      ...
                      for (int hu = 0; hu < hTS; hu++) {
                          for (int an = 0; an < anc; an++) {
                              Xart_15plus += artpop[t][an][g][ha][hm][hu];
                ...
                if (g == FEMALE && pw_artelig[t] > 0 && ha < hAG_FERT) {
                  ...
                  for (int a = hAG_START[ha]; a < hAG_START[ha] + hAG_SPAN[ha]; a++)
                    ...
                    for (int hm = 0; hm < hDS; hm++) {
                      ...
                      for (int hu = 0; hu < hTS; hu++)
                          for (int an = 0; an < anc; an++)
                              frr_pop_ha += frr_art[t][ha - hIDX_FERT][hm][hu] * artpop[t][an][g][ha][hm][hu];
                    }
              ...
              if (med_cd4init_input[t]) {
                ...
                for (int ha = hIDX_15PLUS; ha < hAG; ha++) {
                    ...
                    double new_diagn_ha[hDS] = {};
                    double new_diagn_anc_ha[hDS] = {};
                    double total_new_diagn = 0.0;  // VCT diagnoses newly created by ART initiation
                    double total_new_diagn_anc = 0.0;  // VCT diagnoses newly created by ART initiation
                    double undiagnosed_ha = 0.0;

                    if (t >= t_hts_start) {
                        for (int hm = 0; hm < hDS; hm++) {
                            undiagnosed_ha += hivpop[t][g][ha][hm] -
                                (diagnpop[t][0][g][ha][hm] + diagnpop[t][1][g][ha][hm]);
                        }
                    }
                    ...
                    for (int hm = anyelig_idx; hm < hDS; hm++) {
                        ...
                        double artinit_hahm =
                            artinit_hts *
                            artelig_hahm[ha - hIDX_15PLUS][hm] *
                            ((1.0 - art_alloc_mxweight) / Xartelig_15plus +
                                art_alloc_mxweight * cd4_mort[g][ha][hm] / expect_mort_artelig15plus);
                        ...
                        // fraction of diagnosed in VCT among total diagnosed
                        double diag_total_hahm = diagnpop[t][0][g][ha][hm] + diagnpop[t][1][g][ha][hm];
                        double ancpop_diagn = (diag_total_hahm > 0.0) ? diagnpop[t][0][g][ha][hm] / diag_total_hahm : 1.0;

                        if (t >= t_hts_start) {
                            // "new diagnoses" induced by ART initiations, pooled over ANC
                            double new_diagn = (artinit_hahm > diag_total_hahm) ? artinit_hahm - diag_total_hahm : 0.0;

                            // store by ANC stratum, but these will be pooled later
                            new_diagn_ha[hm] += new_diagn * ancpop_diagn;
                            new_diagn_anc_ha[hm] += new_diagn * (1.0 - ancpop_diagn);
                            total_new_diagn += new_diagn * ancpop_diagn;
                            total_new_diagn_anc += new_diagn * (1.0 - ancpop_diagn);

                            // remove the part of diagnpop that becomes ART without being "new"
                            double non_new = artinit_hahm - new_diagn;
                            diagnpop[t][0][g][ha][hm] -= non_new * ancpop_diagn;
                            diagnpop[t][1][g][ha][hm] -= non_new * (1.0 - ancpop_diagn);


                            // add new diagnoses to diag and late_diag, split by ANC proportion
                            diagnoses[t][0][g][ha][hm] += new_diagn * ancpop_diagn;
                            diagnoses[t][1][g][ha][hm] += new_diagn * (1.0 - ancpop_diagn);
                            late_diagnoses[t][0][g][ha][hm] += new_diagn * ancpop_diagn;
                            late_diagnoses[t][1][g][ha][hm] += new_diagn * (1.0 - ancpop_diagn);
                        }
                        
                        // move people to ART, split by current ANC/VCT composition
                        hivpop[t][g][ha][hm] -= artinit_hahm;
                        artpop[t][0][g][ha][hm][ART0MOS] += artinit_hahm * ancpop_diagn;
                        artpop[t][1][g][ha][hm][ART0MOS] += artinit_hahm * (1.0 - ancpop_diagn);
                        
                        artinits[t][0][g][ha][hm] += artinit_hahm * ancpop_diagn;
                        artinits[t][1][g][ha][hm] += artinit_hahm * (1.0 - ancpop_diagn);
                    }
                    
                    if (t >= t_hts_start && (total_new_diagn) > 0.0) {
                        // "surplus" diagnosed pools by ANC, for this (t,g,ha)
                        double diagn_surplus_ha = 0.0;
                        double diagn_surplus_anc_ha = 0.0;
                        double new_diagn_total_ha = 0.0;
                        double new_diagn_total_ha_anc = 0.0;

                        for (int hm = 0; hm < hDS; hm++) {
                            diagn_surplus_ha += diagnpop[t][0][g][ha][hm];
                            diagn_surplus_anc_ha += diagnpop[t][1][g][ha][hm];

                            new_diagn_total_ha += new_diagn_ha[hm];
                            new_diagn_total_ha_anc += new_diagn_anc_ha[hm];
                        }

                        double diagn_surplus_total_ha = diagn_surplus_ha + diagn_surplus_anc_ha;
                        // pooled fraction to remove from total diagnosed pool (VCT+ANC)
                        double frac_exc_pool = new_diagn_total_ha < diagn_surplus_ha ? new_diagn_total_ha / diagn_surplus_ha : 1.0;
                        double frac_exc_pool_anc = new_diagn_total_ha_anc < diagn_surplus_anc_ha ? new_diagn_total_ha_anc / diagn_surplus_anc_ha : 1.0;

                        // ANC/VCT split of the pooled put-back, per (t,g,ha)

                        for (int hm = 0; hm < hDS; hm++) {


                            double diag_total_hm =
                                diagnpop[t][0][g][ha][hm] + diagnpop[t][1][g][ha][hm];

                            double ratio_anc =
                                diagnpop[t][0][g][ha][hm] + diagnpop[t][0][g][ha][hm] > 0.0
                                ? (diagnpop[t][1][g][ha][hm] / (diagnpop[t][1][g][ha][hm] + diagnpop[t][0][g][ha][hm]))
                                : 1.0;

                            double put_back = frac_exc_pool * diagnpop[t][0][g][ha][hm];
                            double put_back_anc = frac_exc_pool_anc * diagnpop[t][1][g][ha][hm];

                            //double put_back = to_put_back_total * ratio_anc;
                            //double put_back_anc = to_put_back_total * (1.0 - ratio_anc);

                            diagnpop[t][0][g][ha][hm] -= put_back;
                            diagnpop[t][1][g][ha][hm] -= put_back_anc;



                            diagnoses[t][0][g][ha][hm] -= put_back;
                            diagnoses[t][1][g][ha][hm] -= put_back_anc;
                            late_diagnoses[t][0][g][ha][hm] -= put_back;
                            late_diagnoses[t][1][g][ha][hm] -= put_back_anc;
                        ...
                        double proptestneg = undiagnosed_ha > 0 ? (testnegpop[t][1][HIVP][g][ha] + testnegpop[t][0][HIVP][g][ha]) / undiagnosed_ha : 0.0;



                        if (total_new_diagn > diagn_surplus_ha || total_new_diagn_anc > diagn_surplus_anc_ha) {

                            // net new diagnoses after removing surplus
                            total_new_diagn = std::max(0.0, total_new_diagn - diagn_surplus_ha);
                            total_new_diagn_anc = std::max(0.0, total_new_diagn_anc - diagn_surplus_anc_ha);

                            // split by prop_testneg
                            double new_testneg = total_new_diagn * proptestneg;
                            double new_testneg_anc = total_new_diagn_anc * proptestneg;

                            vcttests[t][2][g][ha] += (total_new_diagn - new_testneg) + (total_new_diagn_anc - new_testneg_anc); // never tested
                            vcttests[t][3][g][ha] += new_testneg + new_testneg_anc;                                             // testneg

                            // remove from testnegpop, taking from opposite anc/non-anc as needed
                            double& vct_pool = testnegpop[t][0][HIVP][g][ha];
                            double& anc_pool = testnegpop[t][1][HIVP][g][ha];

                            // First, take what we can from each pool directly
                            double vct_take = std::min(new_testneg, vct_pool);
                            double anc_take = std::min(new_testneg_anc, anc_pool);

                            // Then handle the shortfalls by taking from the opposite pool
                            double vct_shortfall = new_testneg - vct_take;
                            double anc_shortfall = new_testneg_anc - anc_take;

                            if (vct_shortfall > 0) {
                                anc_take += vct_shortfall;
                            }

                            if (anc_shortfall > 0) {
                                vct_take += anc_shortfall;
                            }
                ...
                for (int hm = hDS - 1; hm >= anyelig_idx; hm--) {
                  ...
                  for (int ha = hIDX_15PLUS; ha < hAG; ha++)
                    ...
                    for (int ha = hIDX_15PLUS; ha < hAG; ha++) {
                      ...
                      // does not work with anc module updates
                      /*
                      hivpop[t][g][ha][hm] -= artinit_hahm;
                ...
                for (int ha = hIDX_15PLUS; ha < hAG; ha++) {
                    ...
                    for (int hm = anyelig_idx; hm < hDS; hm++) {
                        ...
                        // fraction of diagnosed in VCT among total diagnosed
                        double diag_total_hahm = diagnpop[t][0][g][ha][hm] + diagnpop[t][1][g][ha][hm]; 
                        // when small volumes of diagn pop present, art init are assumed to be through VCT ( aligned with later late diagn by vct)
                        double ancpop_diagn = std::max(std::min((diag_total_hahm > 1e-9) ? diagnpop[t][0][g][ha][hm] / diag_total_hahm : 1.0, 1.0), 0.0);
          ...
          for (int g = 0; g < NG; g++) {
            ...
            for (int ha = 0; ha < hAG; ha++) {
              ...
              if (ha < hIDX_15TO49 + hAG_15TO49)
                ...
                if (t >= t_hts_start) {
                  double testneg_infections_ha = infections_ha * (testnegpop[t][1][HIVN][g][ha] + testnegpop[t][0][HIVN][g][ha]) / hivn_pop_ha;
                  double testneg_ratio = testnegpop[t][0][HIVN][g][ha] > 0 ? testnegpop[t][0][HIVN][g][ha] / (testnegpop[t][0][HIVN][g][ha] + testnegpop[t][1][HIVN][g][ha]): 1;

                  testnegpop[t][0][HIVN][g][ha] -= testneg_infections_ha * testneg_ratio;
                  testnegpop[t][1][HIVN][g][ha] -= testneg_infections_ha * (1- testneg_ratio);

                  testnegpop[t][0][HIVP][g][ha] += testneg_infections_ha * testneg_ratio;
                  testnegpop[t][1][HIVP][g][ha] += testneg_infections_ha * (1 - testneg_ratio);
          ...
          for (int g = 0; g < NG; g++) {
            ...
            for (int ha = 0; ha < hAG; ha++) {
              ...
              if (t >= t_hts_start) {
                ...
                testnegpop[t][0][HIVN][g][ha] *= 1 + (migrate_hivn_ha);
                testnegpop[t][1][HIVN][g][ha] *= 1 + (migrate_hivn_ha);
                testnegpop[t][0][HIVP][g][ha] *= 1 + (migrate_ha);
                testnegpop[t][1][HIVP][g][ha] *= 1 + (migrate_ha);
              ...
              for (int hm = 0; hm < hDS; hm++) {
                ...
                if (t >= t_hts_start) {
                    diagnpop[t][0][g][ha][hm] *= 1 + (migrate_ha);
                    diagnpop[t][1][g][ha][hm] *= 1 + (migrate_ha);

                    if (t >= t_ART_start) {
                        for (int hu = 0; hu < hTS; hu++) {
                            artpop[t][0][g][ha][hm][hu] *= 1 + (migrate_ha);
                            artpop[t][1][g][ha][hm][hu] *= 1 + (migrate_ha);
          ...
          for (int g = 0; g < NG; g++) {
            ...
            for (int ha = 0; ha < hAG; ha++) {
              ...
              if (t >= t_hts_start) {
                ...
                testnegpop[t][0][HIVN][g][ha] *= (hivn_adj_ha);
                testnegpop[t][1][HIVN][g][ha] *= (hivn_adj_ha);
                testnegpop[t][0][HIVP][g][ha] *= (hivpop_adj_ha);
                testnegpop[t][1][HIVP][g][ha] *= (hivpop_adj_ha);
              ...
              for (int hm = 0; hm < hDS; hm++) {
                ...
                if (t >= t_hts_start) {
                    diagnpop[t][0][g][ha][hm] *= (hivpop_adj_ha);
                    diagnpop[t][1][g][ha][hm] *= (hivpop_adj_ha);
              ...
              if (t >= t_ART_start) {
                ...
                for (int hm = 0; hm < hDS; hm++) {
                    for (int hu = 0; hu < hTS; hu++) {
                        for (int an = 0; an < anc; an++)
                            artpop_ha += artpop[t][an][g][ha][hm][hu];
                    }
                }
                ...
                for (int hm = 0; hm < hDS; hm++) {
                    for (int hu = 0; hu < hTS; hu++) {
                        for (int an = 0; an < anc; an++)
                            artpop[t][an][g][ha][hm][hu] *= artpop_adj_ha;
                    }
                }
              }
            } // loop over ha
